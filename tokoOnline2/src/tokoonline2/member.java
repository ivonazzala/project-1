...
this.namaMember.add("nanda");
this.alamat.add("bulakrejo");
this.telepon.add("0840390923");
this.saldo.add(250000);
this.namaMember.add("zaidaan");
this.alamat.add("bungurasih");
this.telepon.add("0849348403");
this.saldo.add(325000);
this.namaMember.add("faisal");
this.alamat.add("klojen");
this.telepon.add("\t0897393287");
this.saldo.add(2250000);
this.namaMember.add("monyet");
}
